...
class GCode:
    ...
    '''
    desc: Upon reception of a resend message, this function extracts the line number in the message
    params: 
        message: 
            desc: The error message from the controller
            type: String
    '''
...
class MachineMotion:
    ...
    '''
    desc: function that initiates the homing sequence of all axes. The sequence homes all axes using the endstop signals
    pathToExampleCode:  ./example--emitHomeAll.py
    '''
        global motion_completed
